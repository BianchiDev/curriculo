    ...
    <section className={styled.leftContainer}>
      ...
      <div className={styled.contact}>
        ...
        <p>
          <FaPhoneAlt />{" "}
          <a
            href="https://wa.me/5511948413923"
            target="_blank"
            rel="noreferrer"
          >
            (11) 94841-3923
        ...
        <p>
          <FaEnvelope />{" "}
          <a
            href="mailto:contato@mariopaglia.dev.br"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <p>
          <FaLinkedin />{" "}
          <a
            href="https://linkedin.com/in/mariopagliadev"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <p>
          <FaGithub />{" "}
          <a
            href="https://github.com/mariopaglia"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <p>
          <SiLinktree />{" "}
          <a
            href="https://linktr.ee/devmariopaglia"
            target="_blank"
            rel="noreferrer"
          >
